#!/bin/bash
# Master build script for SoundBridge release builds
...
echo "Building SoundBridgePlus Release (Universal Binary)"
echo "==============================================="
echo ""
...
build_swift_universal "$PROJECT_ROOT/packages/host" "SoundBridgeHost"
...
build_swift_universal "$PROJECT_ROOT/apps/mac/SoundBridgeApp" "SoundBridgeApp"
...
echo "----------------------------------------"
echo ""
echo "App bundle: $PROJECT_ROOT/dist/SoundBridgePlus.app"
echo ""
echo "Verify architectures:"
echo "  lipo -archs dist/SoundBridgePlus.app/Contents/MacOS/SoundBridgeApp"
echo "  lipo -archs dist/SoundBridgePlus.app/Contents/MacOS/SoundBridgeHost"
echo ""
echo "To test the app:"
echo "  open dist/SoundBridgePlus.app"
echo ""
